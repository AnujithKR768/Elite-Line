...
export default function Create({ philosophies = [] }) {
    ...
    const submit = (e) => {
        ...
        post("/pricing-point/store"); // ✅ route
    };
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter pricing point"
                            className="w-full border rounded-lg px-3 py-2"
                        />
